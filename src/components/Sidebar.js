...
const Sidebar =({author,authorFuild})=>(
    <div>
      {author && (
      <Card>
        <Img className="card-image-top" fluid={authorFuild} />
        <CardBody>
        ...
        <Card>
            <CardBody>
                ...
                <Form className='text-center'>
                    ...
                    <Button className='btn outline  text-uppercase' color="success">
                        Subsribe
                    </Button>
                </Form>
            </CardBody>
            ...
            <Card>
                <CardBody>
                    <CardTitle className='text-center text-uppercase mb-3'>Advertisement</CardTitle>
                    <img alt="asaasa" src='https://via.placeholder.com/320x200' style={{width:'100%'}}></img>
                </CardBody>
            </Card>
            <Card>
                <CardBody>
